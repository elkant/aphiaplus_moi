...
int weeks = Weeks.weeksBetween(dateTime1, dateTime2).getWeeks();
           ...
           Row rw0=rawdata.createRow(0);
            ...
            String where=" (enddate between '"+startdate+"' and '"+enddate+"')  "+countywhere+" and id  like '%_weekly%' ";      
            String where1=" (enddate between '"+startdate+"' and '"+enddate+"') and id  like '%_weekly%'  ";      
